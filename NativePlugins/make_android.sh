...
cp build_v7a/tstunity.so ../PluginsBuild/NativePlugins/Android/libs/armeabi-v7a/tstunity.so
...
cp build_x86/tstunity.so ../PluginsBuild/NativePlugins/Android/libs/x86/tstunity.so
