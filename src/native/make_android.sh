...
mkdir -p ../../Build/Native/Android/libs/armeabi-v7a/
cp build_v7a/libtstunity.so ../Build/Native/Android/libs/armeabi-v7a/libtstunity.so
...
mkdir -p ../../Build/Native/Android/libs/x86/
cp build_x86/libtstunity.so ../../Build/Native/Android/libs/x86/libtstunity.so
